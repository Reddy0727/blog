...
function Signup() {
 ...
 const handleSubmit = async (e) => {
  ...
  return (
    <div className=" min-h-screen   px-3 mx-auto mt-0 md:flex-0 shrink-0 bg-slate-300 flex items-center justify-center ">
  <div className="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
    <div className="p-4 mb-0 text-center bg-white border-b-0 rounded-t-2xl">
      <h5 className="text-2xl font-semibold">Signup with</h5>
    </div>
